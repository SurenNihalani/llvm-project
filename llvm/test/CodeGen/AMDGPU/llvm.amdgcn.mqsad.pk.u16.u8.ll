; RUN: llc -mtriple=amdgpu6.00 < %s | FileCheck -check-prefixes=GCN %s
; RUN: llc -mtriple=amdgpu8.03 < %s | FileCheck -check-prefixes=GCN %s
; RUN: llc -mtriple=amdgpu13.10 < %s | FileCheck -check-prefixes=GFX13 %s
...
; GFX13-LABEL: {{^}}v_mqsad_pk_u16_u8_non_immediate:
; GFX13: v_mqsad_pk_u16_u8 v[0:1], v[2:3], v4, v[6:7]
