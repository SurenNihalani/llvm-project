...
// CHECK-NEXT:    [[TMP6:%.*]] = load double, ptr addrspace(5) [[D_ADDR]], align 8
...
// CHECK-NEXT:    [[TMP10:%.*]] = call double @llvm.amdgcn.raw.ptr.buffer.atomic.fmin.f64(double [[TMP6]], ptr addrspace(8) [[TMP7]], i32 [[TMP8]], i32 [[TMP9]], i32 0)
// CHECK-NEXT:    [[TMP11:%.*]] = load ptr addrspace(1), ptr addrspace(5) [[DOUT_ADDR]], align 8
// CHECK-NEXT:    store double [[TMP10]], ptr addrspace(1) [[TMP11]], align 8
// CHECK-NEXT:    ret void
//
void test_raw_ptr_buffer_atomic_fmin(global float *fout, global double *dout, __amdgpu_buffer_rsrc_t rsrc, float f, double d, int offset, int soffset)
{
